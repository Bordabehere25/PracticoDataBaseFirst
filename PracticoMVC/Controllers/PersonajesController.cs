...
namespace PracticoMVC.Controllers
{
    public class PersonajesController : Controller
    {
        ...
        public PersonajesController(EscritorioContext context)
        {
            _context = context;
        }
        ...
        {
            var escritorioContext = _context.Personajes.Include(p => p.PerLib).Include(p => p.PerRol);
            return View(await escritorioContext.ToListAsync());
        }
